...
<main class="main-content">
    ...
    <div class="container-fluid">
        ...
        <!-- end::page header -->
<!-- 表格 -->
		<form action="/shop2/admin/Update" method="post" style="width: 50%;margin-left: 200px">
			<div class="form-group mb-4">
			<!-- key -->
			<input type="hidden" name="key" value="${aUser.aname}"/>
				<input type="text" name="aname" value="${aUser.aname}"
					class="form-control form-control-lg" autofocus
					placeholder="Username">
			</div>
			<div class="form-group mb-4">
				<input type="text" name="apwd" value="${aUser.apwd}"
