        ...
        <div class="col-lg-4 offset-lg-1">
            ...
            <form action="/shop2/admin/login" method="post">
                    ...
                    <div class="col-md-6 mb-4">
                        <a href="/shop2/buserlogin.jsp" class="btn btn-outline-facebook btn-block">
                            <i class="fa fa-facebook-square m-r-5"></i> 用户登录
                        </a>
                    </div>
                    <div class="col-md-6 mb-4">
                        <a href="/shop2/login.jsp" class="btn btn-outline-google btn-block">
                            <i class="fa fa-google m-r-5"></i>管理员登录
                        </a>
                    </div>
                </div>
