                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <c:forEach items="${buserList}" var="buser" varStatus="buserstatus">
                                <tr>
                                    <th scope="row">${buserstatus.index+1}</th>
                                    <td>${buser.bemail}</td>
                                    <td>${buser.bpwd}</td>
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a href="/shop2/buser/toUpdate?id=${buser.id}" class="dropdown-item" type="button">修改</a>
                                                <a href="/shop2/buser/delete?id=${buser.id}" class="dropdown-item" type="button">删除</a>
