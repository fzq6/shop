...
<div class="side-menu">
    <div class='side-menu-body'>
        <ul>
            ...
            <li class="open">
                <a href="#"><i class="icon ti-home"></i> <span>管理员</span> </a>
                <ul>
                    <li><a class="active" href="/shop2/admin/queryAllAdmin">管理员列表</a></li>
                    <li><a href="/shop2/register.jsp">添加管理员</a></li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="/shop2/buser/queryAllBuser">用户列表</a></li>
                    <li><a href="/shop2/buserregister.jsp">添加用户</a></li>
                    
                </ul>
            </li>
            <li><a href="#"><i class="icon ti-rocket"></i> <span>商品模块</span> </a>
                <ul>
                    <li><a href="chat.html">商品列表 </a></li>
                    <li><a href="/shop2/goodsInsert.jsp">发布商品 </a>  </li>
                </ul>
            </li>
            <li><a href="#"><i class="icon ti-layers-alt"></i> <span>UI Elements</span> </a>
                <ul>
