...
<main class="main-content">
    ...
    <div class="container-fluid">
        ...
        <!-- end::page header -->
<!-- 表格 -->
		<form action="/shop2/buser/Update" method="post" style="width: 50%;margin-left: 200px">
			<div class="form-group mb-4">
			<!-- key -->
			<input type="hidden" name="key" value="${bUser.bemail}"/>
				<input type="text" name="bemail" value="${bUser.bemail}"
					class="form-control form-control-lg" autofocus
					placeholder="Username">
			</div>
			<div class="form-group mb-4">
				<input type="text" name="bpwd" value="${bUser.bpwd}"
					class="form-control form-control-lg" placeholder="Password">
			</div>
			<hr>
			<h3>${message}</h3>
			<button type="submit"
				class="btn btn-primary btn-lg btn-block btn-uppercase mb-4"> SUBMIT </button>
		</form>
		<!-- 表格 -->
    </div>
