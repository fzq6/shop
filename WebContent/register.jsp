...
<div class="container h-100-vh">
    <div class="row align-items-md-center h-100-vh">
        ...
        <div class="col-lg-4 offset-lg-1">
            ...
            <form action="/shop2/admin/register" method="post">
                <div class="form-group mb-4">
                    <input type="text" name="aname" value="${aUser.aname}" class="form-control form-control-lg" autofocus placeholder="Username">
                </div>
                <div class="form-group mb-4">
                    <input type="password" name="apwd" value="${aUser.apwd}" class="form-control form-control-lg" placeholder="Email">
                </div>
				<hr>
				<h3>${message}</h3>
