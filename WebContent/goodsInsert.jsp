...
<main class="main-content">
    ...
    <div class="container-fluid">
        ...
        <!-- end::page header -->
			<div class="card">
                <div class="card-body">
                    <h5 class="card-title">商品发布</h5>
                    <form action="/shop2/goods/insert" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name = "goodstypeId" id="category">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="goprice" name="goprice"
                                   placeholder="请输入价格">
                        </div>
                           <div class="form-group">
                            <label for="grprice">商品促销价</label>
                            <input type="text" class="form-control" id="grprice" name="grprice"
                                   placeholder="请输入促销价">
                        </div>
                        <div class="form-group">
