...
<div class="container h-100-vh">
    <div class="row align-items-md-center h-100-vh">
        ...
        <div class="col-lg-4 offset-lg-1">
            ...
            <form action="/shop2/admin/login" method="post">
                <div class="form-group mb-4">
                    <input type="text" name = "aname" class="form-control form-control-lg" id="exampleInputEmail1" autofocus placeholder="Email or username">
                </div>
                <div class="form-group mb-4">
                    <input type="password" name = "apwd" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Password">
                </div>
                ...
                <div class="text-center">
                    Don't have an account? <a href="/shop2/register.jsp" class="text-primary">Create</a>
                </div>
            </form>
        </div>
    </div>
